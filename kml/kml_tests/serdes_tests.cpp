...
kml::FileData GenerateKmlFileData()
{
  ...
  result.m_categoryData.m_authorName = "Gruntify Drive";
  ...
  compilationData1.m_authorName = "Gruntify Drive";
  ...
  compilationData2.m_authorName = "Gruntify Drive";
...
<Document>
  ...
  <ExtendedData xmlns:mwm="https://omaps.app">
    ...
    <mwm:author id="12345">Gruntify Drive</mwm:author>
    ...
    <mwm:compilation id="1" type="Collection">
      ...
      <mwm:author id="54321">Gruntify Drive</mwm:author>
    ...
    <mwm:compilation id="4" type="Category">
      ...
      <mwm:author id="11111">Gruntify Drive</mwm:author>
